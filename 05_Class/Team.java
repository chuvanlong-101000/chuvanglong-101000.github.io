...
public class Team {
    ...
    private long budget;// số tiền quỹ củ câu lạc bộ
    //private giới hạn trong nội bộ class
    ...
    public Team(String name, String stadium, String coach ,String establishedYear ){
        this.name = name;
